...
<div class="modal fade" id="edit<?= $keys['id'] ?>" data-bs-backdrop="static" tabindex="-1"
    ...
    <div class="modal-dialog">
        <form action="{{route('workshop.update', $keys->id)}}" method="POST">
            @csrf
            @method('PATCH')
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" class="form-control" name="nomatelier" id="" value="{{$keys['nomatelier']}}">
                    <input type="hidden" name="usine_id" value="{{$keys->usine_id}}">

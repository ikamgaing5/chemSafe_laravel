                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-12">
                            <div class="shadow-lg page-title flex-wrap d-none d-xl-block">
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <u><a href="/workshop/all-workshop/{{$atelier->usine->id}}" class="text-primary fw-bold fs-5">{{$atelier->usine->nomusine}}</a></u>
                                        
                                            <i class="bi bi-caret-right-fill"></i>
                                            <u><a class="text-primary fw-bold fs-5" href="{{route('product.forworkshop',$atelier->id)}}">
                                                    {{$atelier->nomatelier}}
                                                </a>
                                            </u>
                            ...
                            <div class="shadow-lg page-title d-xl-none text-center py-2">
                                ...
                                <u><a href="/all-products/{{$atelier->id}}"
                            ...
                            <div class="card shadow-lg">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-md-7">
                                            <img src="{{ asset('storage/' . $prod->photo) }}" alt="photo produit" class="img-fluid rounded shadow">
                                        </div>
